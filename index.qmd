...
\begin{gather*}
H(X_{j,t}) = -\sum_{i = 0}^Np(x_{k, j, t})\log_2p(x_{k, j, t})
\end{gather*}
...
- I presented the limitations of the entropy model and explained the resource requirement for a neural network as well as why it generates more reliable results (with less false positives).
